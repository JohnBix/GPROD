...
if (!empty($_SESSION) && array_key_exists("email", $_SESSION)):
    ...
    $all = $uc->findAllUsers()["users"];

?>
<h2 class="pt-4">All Users</h2>
<p>List of all available users.</p>
